...
// Source: github.com/Damon-V79/act-transition-api/internal/app/repo (interfaces: EventRepo)
...
import (
	...
	model "github.com/Damon-V79/act-transition-api/internal/model"
...
func (m *MockEventRepo) Add(arg0 context.Context, arg1 []model.TransitionEvent) error {
	m.ctrl.T.Helper()
...
func (m *MockEventRepo) Lock(arg0 context.Context, arg1 uint64) ([]model.TransitionEvent, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Lock", arg0, arg1)
	ret0, _ := ret[0].([]model.TransitionEvent)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
