...
// Source: github.com/Damon-V79/act-transition-api/internal/app/sender (interfaces: EventSender)
...
func (m *MockEventSender) Send(arg0 context.Context, arg1 *model.TransitionEvent) error {
	m.ctrl.T.Helper()
